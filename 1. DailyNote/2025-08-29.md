...
Làm sao để ôm các phần lớn hơn của hệ thống và mục đích của việc đó là gì, thay vì chỉ ôm các việc nhỏ


MINDSET KẺ CHIẾN THẮNG, là 1 khách hàng bạn thích người to hay nhỏ 
...
Vv handle model AI Đề xuất tình huống  

Cuong Vu Cao, _domain_disabled_


@Quân Trần Ngọc ơi, **nếu service đề xuất AI bị lỗi** (backup thế, biết đâu được), thì e **mặc định trả về cho users lộ trình cơ bản nhé**  

  

Còn @Ngọc Cường Đoàn xử lý các phần việc để tránh có lỗi đi  

  

@ThanhDT ơi, e support Cường đẩy service lên production nhé, giờ mới update xong  

  

Quân Trần Ngọc, _domain_disabled_
...
hiện bị lỗi thì đang cho về WORK_GENERAL
