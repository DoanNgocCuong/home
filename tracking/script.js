...
class AdvancedWritingTracker {
    ...
    async scanArticles() {
        ...
        try {
            // Call Python script to scan articles
            const articles = await this.callPythonScript(scanPath, includeSubfolders);
            ...
            this.showStatus(`Đã quét thành công ${articles.length} bài viết!`, 'success');
    ...
    async callPythonScript(scanPath, includeSubfolders) {
        // This will call the Python script to scan articles
        // For now, we'll use a mock implementation
        // In production, you would use fetch() to call the Python server
