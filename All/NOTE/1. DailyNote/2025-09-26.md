...
## 📌 Tóm tắt Daily Meeting – Robot Project

### 🎯 Monthly Goal (Mốc 01/10 – Ver 1)

- **Robot**: Full luồng giao bài & tự điều hướng (bao gồm Agent chào hỏi, adaptive theo mức độ tập trung…). Phụ huynh **không cần thao tác tay**.
    
- **Phụ huynh**: Full luồng setup, dashboard, đặt báo thức.
    
- **Content**: Đủ cho đội A1.2 (song ngữ) và A2.2 (full English) trong 15–20 ngày.
    
- **Tech**: Đã xử lý các tắc nghẽn (ASR + báo UX mạng).
...
- **Goal tuần**: Train check phát âm (đánh giá kết quả), giảm 20% chi phí hạ tầng, đánh giá mạch Pa3.
    
- **Hôm qua**: Có kết quả train → cần giáo viên đánh giá, tối ưu VAD, làm việc bảo mật.
    
- **Hôm nay**: Tiếp tục đánh giá check phát âm & VAD ngữ nghĩa.
    
- **Blocker**: VAD ngữ nghĩa chưa ổn.
    

#### Việt – BE

- **Goal**: Code adaptive learning, CMS (đăng nhập, phân quyền, UI quản lý bài).
    
- **Hôm qua**: Support test robot, update logic dynamic activity.
    
- **Hôm nay**: Ghép UI CMS (view + nhập liệu roadmap), phân quyền nhập liệu.
    

#### Quân – BE

- **Goal**: Hoàn thành luồng navigation.
    
- **Hôm qua/Hôm nay**: Test & fix bug logic điều hướng.
    
- **Blocker**: Chờ data adaptive từ Long để test.
    

#### Thành – BE

- (chưa có update chi tiết).
    

#### Hiếu – Lead FE

- **Goal**: Bảo mật (RSA), kết nối bluetooth, wifi.
    
- **Hôm qua**: Tìm hiểu RSA ESP32, setup MTU, update logic wifi.
    
- **Hôm nay**: Dựng flow RSA, thêm wake word model (chuyển cho Hieu Tran Trung).
    

#### Linh – FE

- **Goal**: Tool build bài (ROB-190).
    
- **Hôm qua**: Trao đổi với Cường, fix bug critical.
    
- **Hôm nay**: Ghép phần gen assets, tiếp tục build tool.
    

#### Cường – AI PM

- **Goal**: Scale ASR (~100h), tối ưu response-time, giảm chi phí AI 30%.
    
- **Hôm qua**: Train batch ASR mới, review roadmap.
    
- **Hôm nay**: Xử lý giảm response-time, lên plan tối ưu chi phí, breakdown task team build bài.
    

#### Minh – AI PO

- **Goal**: Điều phối 3 agent điều hướng, test API navigation, define UX error.
    
- **Hôm qua**: Meet tester, define case, tính tiền bài học.
    
- **Hôm nay**: Align timeline AI refactor, push data gán nhãn, chuẩn bị test case.
    

#### Hưng – AI

- **Goal**: Tool build bài (4h → 2h), build 40 bài, refactor agent core.
    
- **Hôm qua**: Fix bug gen thiếu checkpoint, triển khai đẩy bài lên hệ thống.
    
- **Hôm nay**: Tiếp tục refactor, hỗ trợ CTV, gen riêng từng part.
    

#### Đoàn Cường – AI

- **Goal**: Refactor Workflow (MySQL → Postgres).
    
- **Hôm qua/Hôm nay**: Hoàn thiện API init & basic workflow, test DB mới.
    
- **Next**: v1.1 Happy case, v1.2 Unhappy case.
    

#### Trang – Product PM

- **Goal**: Refactor onboarding 10’, planning roadmap & GTM, nghiệm thu pipeline.
    
- **Hôm qua**: Done PRD onboarding, test pipeline build bài.
    
- **Hôm nay**: Nghiệm thu pipeline content, set up test, build bài onboarding, chốt giọng Pika.
    

#### Long – Acad

- **Goal**: Content hàng loạt (A1.2 double version, A2.2), QC, test template mới.
    
- **Hôm qua**: Chuốt PRD, test cuốn chiếu.
    
- **Hôm nay**: Gen audio, hackathon với Giang, tìm creative content.
    

#### Dịu – PE

- **Goal**: Navigation v1, Buddy Talk, Agent template v1, đóng gói 7 ngày đầu.
    
- **Hôm qua**: Sửa UX, test thông luồng Navigation-Agent.
    
- **Hôm nay**: Build bot ID test UX, tiếp tục Agent Talk v2.
    

#### Thuỳ Dương – PE

- **Goal**: Vận hành content hàng loạt, QC output, training CTV.
    
- **Hôm qua**: Test tool gen ảnh/audio, nhập liệu lộ trình mới.
    
- **Hôm nay**: Tiếp tục check PRD chi tiết, gen nguyên liệu, tăng hiệu suất tool build bài (50%→60%).
    

#### Hải – Design

- **Goal**: Package hộp, design system, dashboard, tool servo.
    
- **Hôm qua**: Checklist biểu cảm, test AI gen servo.
    
- **Hôm nay**: Design dashboard, review servo, benchmark.
    

#### Minh Anh – Design

- **Goal**: GIF biểu cảm, UX Navigation, gamification.
    
- **Hôm qua**: Hoàn thành 10–15 GIF, thiết kế elements.
    
- **Hôm nay**: Combo UX, màn checkpoint, gamification.
    

#### Hồng Dương – PE

- **Goal**: Dashboard, onboarding, weekly report.
    
- **Hôm qua**: Check log, viết PRD dashboard, lên idea onboarding.
    
- **Hôm nay**: Design lại onboarding, align trải nghiệm 7 ngày.
    

---

👉 **Tổng kết**: Dự án đang tiến đúng hướng tới mốc **01/10 Ver 1**, với trọng tâm:

- **Tech**: hoàn thiện train phát âm, VAD, bảo mật RSA, luồng wifi/bluetooth.
    
- **BE/FE**: CMS, navigation, tool build bài.
    
- **AI**: ASR scale, refactor workflow/agent, giảm response-time.
    
- **Acad/PE**: sản xuất & QC content hàng loạt, build onboarding 7 ngày.
    
- **Design**: hoàn thiện dashboard, biểu cảm, gamification.
    

Quốc có muốn mình viết lại summary này thành **bảng ngắn gọn theo 3 cột: Member – Focus – Blocker** để dễ tracking hằng ngày không?
