...
Đề bài công ty thực tế đang nghiên cứu triển khai: **Memory-Augmented AI Agents** and **Personalize AI Agents - Trợ lý Cá Nhân** cho User. 
- Bắt đầu từ các con Agents, Workflows - cho User nói tiếng anh luyện tập: 2 dạng chính là: trò chuyện free talk + 2 là các dạng bài cụ thể (Agents - Chain of Promp / Workflow / Cả Agent và Workflow + Đính thêm tools Agent/Search API Real time, ...) [BÀI NÀY CÔNG TY EM ĐÃ TRIỂN KHAI XONG] . Bài này còn đã có mapping Response của AI với các trường khác như: MOOD, ACTION, Image => Làm cử động và biểu cảm trên con Robot. 
...
3. Một số vấn đề là: 
	- Agent/Alg để extract và lưu như nào? 
	- Agent/Alg để truy vấn data từ trong bộ nhớ ra sao? Trường hợp data trong bộ nhớ tăng lên thì sao? 
	- Tối ưu Response time khi triển khai thực tế, ... 
