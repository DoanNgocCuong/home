...
### 5. Clone hoặc push với tài khoản mới

Khi clone repo cho tài khoản mới, dùng:

```bash
git clone git@github-new:username/repo.git
```

Hoặc đổi remote của repo cũ:
...
Nếu bạn cần hướng dẫn chi tiết hơn ở bước nào, hãy nói nhé!
