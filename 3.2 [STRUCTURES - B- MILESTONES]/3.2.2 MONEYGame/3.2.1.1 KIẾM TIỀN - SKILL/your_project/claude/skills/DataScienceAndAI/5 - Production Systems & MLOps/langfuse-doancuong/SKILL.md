...
```1242:1251:app/api/services/bot_services.py
@observe(name="bot_services.webhook-service", capture_input=False, capture_output=True)
...
---
## SAI LẦM 1.5: VẤN ĐỀ GIL CONTENTION - 
